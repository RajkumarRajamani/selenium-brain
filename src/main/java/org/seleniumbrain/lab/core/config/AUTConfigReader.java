...
import org.seleniumbrain.lab.core.config.pojo.AUTConfiguration;
 ...
 *
 * Ensure that YML configurations are following the structure as in the {@link AUTConfiguration}
 *
 */
public class AUTConfigReader {
    ...
    private static final AUTConfiguration autConfig;

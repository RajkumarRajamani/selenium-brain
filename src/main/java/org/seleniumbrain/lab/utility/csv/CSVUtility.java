...
public class CSVUtility {
    ...
    public static List<?> readCsv(String fileName, Class<?> type) throws IOException {
        return new CsvToBeanBuilder<>(new FileReader(fileName, StandardCharsets.ISO_8859_1))
                .withType(type)
                .withQuoteChar('"')
                .withSeparator(',')
    ...
    public static List<?> readCsv(String fileName, Class<?> type, int skipLines) throws IOException {
        return new CsvToBeanBuilder<>(new FileReader(fileName, StandardCharsets.ISO_8859_1))
                .withType(type)
                .withQuoteChar('"')
                .withSeparator(',')
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sJava="\\u0048\\u0065\\u006C\\u006C\\u006F \u00C1";
        System.out.println("Unescape Empty String: " + StringEscapeUtils.unescapeJava(null));
...
//        CSVUtility.readCsv(fileName, Model.class).forEach(System.out::println);
        List<Prototype> list = (List<Prototype>) CSVUtility.readCsv(fileName, Prototype.class);
